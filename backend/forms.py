...
class ProcurementForm(Form):
    ...
    container = SelectField('Container', choices=container_choices, description="What is the smallest unit of packaging?")
    pack_size = IntegerField('Pack size', [validators.InputRequired()], description="How many units are there in a pack?")
    pack_price = FloatField('Pack price', [validators.InputRequired()], description="What is the price of on pack/bottle?")
    ...
    unit_price_usd = FloatField('Unit price in USD', [validators.InputRequired()], description="This is the price we use for making comparisons.")
