...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CountryMappingCode'
        db.create_table('registrations_countrymappingcode', (
        ...
        db.send_create_signal('registrations', ['CountryMappingCode'])


    def backwards(self, orm):
        # Deleting model 'CountryMappingCode'
        db.delete_table('registrations_countrymappingcode')
    ...
    models = {
        ...
        'registrations.countrymappingcode': {
            'Meta': {'object_name': 'CountryMappingCode'},
