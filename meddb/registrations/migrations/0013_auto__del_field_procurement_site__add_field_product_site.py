...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Procurement.site'
        db.delete_column('registrations_procurement', 'site_id')

        # Adding field 'Product.site'
        db.add_column('registrations_product', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registrations.Site'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Procurement.site'
        db.add_column('registrations_procurement', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registrations.Site'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.site'
        db.delete_column('registrations_product', 'site_id')
