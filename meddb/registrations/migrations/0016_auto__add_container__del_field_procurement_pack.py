...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('registrations_container', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('quantity', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('registrations', ['Container'])

        # Deleting field 'Procurement.pack'
        db.delete_column('registrations_procurement', 'pack_id')


    def backwards(self, orm):
        # Deleting model 'Container'
        db.delete_table('registrations_container')

        # Adding field 'Procurement.pack'
        db.add_column('registrations_procurement', 'pack',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registrations.PackSize'], null=True),
                      keep_default=False)
