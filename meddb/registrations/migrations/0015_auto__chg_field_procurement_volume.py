...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Procurement.volume'
        db.alter_column('registrations_procurement', 'volume', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Procurement.volume'
        db.alter_column('registrations_procurement', 'volume', self.gf('django.db.models.fields.IntegerField')(null=True))
