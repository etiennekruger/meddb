...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Procurement.currency'
        db.add_column('registrations_procurement', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['registrations.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Procurement.currency'
        db.delete_column('registrations_procurement', 'currency_id')
