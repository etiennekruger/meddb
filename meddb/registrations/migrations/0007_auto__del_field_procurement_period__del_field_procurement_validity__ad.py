...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Procurement.period'
        db.delete_column('registrations_procurement', 'period')

        # Deleting field 'Procurement.validity'
        db.delete_column('registrations_procurement', 'validity')

        # Adding field 'Procurement.start_date'
        db.add_column('registrations_procurement', 'start_date',
                      self.gf('django.db.models.fields.DateField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Procurement.end_date'
        db.add_column('registrations_procurement', 'end_date',
                      self.gf('django.db.models.fields.DateField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Procurement.period'
        db.add_column('registrations_procurement', 'period',
                      self.gf('django.db.models.fields.IntegerField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Procurement.validity'
        db.add_column('registrations_procurement', 'validity',
                      self.gf('django.db.models.fields.DateField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Procurement.start_date'
        db.delete_column('registrations_procurement', 'start_date')

        # Deleting field 'Procurement.end_date'
        db.delete_column('registrations_procurement', 'end_date')
