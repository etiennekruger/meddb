...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('registrations_product', 'manufacturer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['registrations.Manufacturer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.manufacturer'
        db.delete_column('registrations_product', 'manufacturer_id')
