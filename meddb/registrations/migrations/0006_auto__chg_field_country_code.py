...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('registrations_country', 'code', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Country.code'
        db.alter_column('registrations_country', 'code', self.gf('django.db.models.fields.CharField')(max_length=2))
