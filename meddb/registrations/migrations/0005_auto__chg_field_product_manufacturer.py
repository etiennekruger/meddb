...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('registrations_product', 'manufacturer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registrations.Manufacturer'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Product.manufacturer'
        raise RuntimeError("Cannot reverse this migration. 'Product.manufacturer' and its values cannot be restored.")
