...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackSize.registration'
        db.delete_column('registrations_packsize', 'registration_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PackSize.registration'
        raise RuntimeError("Cannot reverse this migration. 'PackSize.registration' and its values cannot be restored.")
