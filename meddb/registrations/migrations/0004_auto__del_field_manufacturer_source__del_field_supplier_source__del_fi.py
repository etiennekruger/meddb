...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Manufacturer.source'
        db.delete_column('registrations_manufacturer', 'source_id')

        # Deleting field 'Supplier.source'
        db.delete_column('registrations_supplier', 'source_id')

        # Deleting field 'Site.source'
        db.delete_column('registrations_site', 'source_id')

        # Deleting field 'Product.source'
        db.delete_column('registrations_product', 'source_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Manufacturer.source'
        raise RuntimeError("Cannot reverse this migration. 'Manufacturer.source' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Supplier.source'
        raise RuntimeError("Cannot reverse this migration. 'Supplier.source' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Site.source'
        raise RuntimeError("Cannot reverse this migration. 'Site.source' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Product.source'
        raise RuntimeError("Cannot reverse this migration. 'Product.source' and its values cannot be restored.")
