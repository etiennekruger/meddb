...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Procurement.container'
        db.add_column('registrations_procurement', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['registrations.Container']),
                      keep_default=False)

        # Adding field 'Procurement.packsize'
        db.add_column('registrations_procurement', 'packsize',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Procurement.container'
        db.delete_column('registrations_procurement', 'container_id')

        # Deleting field 'Procurement.packsize'
        db.delete_column('registrations_procurement', 'packsize')
