...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Supplier.prequalify'
        db.delete_column('registrations_supplier', 'prequalify')


    def backwards(self, orm):
        # Adding field 'Supplier.prequalify'
        db.add_column('registrations_supplier', 'prequalify',
