...
def upgrade():
    ...
    op.add_column('procurement', sa.Column('approved', sa.Boolean(), nullable=True, default=False))
    # op.drop_column('product', 'is_generic')
    op.add_column('product', sa.Column('is_generic', sa.Boolean(), nullable=True, default=True))
    # op.drop_column('registration', 'expired')
    op.add_column('registration', sa.Column('expired', sa.Boolean(), nullable=True, default=False))
    # op.drop_column('supplier', 'authorized')
    op.add_column('supplier', sa.Column('authorized', sa.Boolean(), nullable=True, default=False))
    # op.drop_column('user', 'is_admin')
    # op.drop_column('user', 'activated')
    op.add_column('user', sa.Column('activated', sa.Boolean(), nullable=True, default=False))
